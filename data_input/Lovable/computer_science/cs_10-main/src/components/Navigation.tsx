      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <Link to="/" className="flex items-center space-x-2 text-primary hover:opacity-80 transition-opacity">
            ...
            <span className="font-bold text-xl hidden sm:inline">CS Bachelor's Program</span>
            <span className="font-bold text-xl sm:hidden">CS Program</span>
          </Link>
          ...
          <div className="hidden md:flex items-center space-x-1">
            ...
            <Button asChild variant="default" className="ml-4 bg-accent hover:bg-accent/90">
